...
public class ProductMapperTest {
    ...
    public void testMapToProduct() {
        ...
        ProductDto productDto = new ProductDto(1L, dateFromTest, 1.0, 2.0, 3.0, 4.0, new BigDecimal(100), "test_url");
        //When
    ...
    public void testMapToProductDto() {
        //Given
        Product product = new Product(1L, dateFromTest, 1.0, 2.0, 3.0, 4.0, new BigDecimal(100), "test_url");
        //When
    ...
    public void testMapToProductDtoList() {
        //Given
        List<Product> products = List.of(new Product(1L, dateFromTest, 1.0, 2.0, 3.0, 4.0, new BigDecimal(100), "test_url"));
        //When
